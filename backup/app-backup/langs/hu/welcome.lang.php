...
A program gyakorlati és ipari fókuszú megközelítésben biztosít szakmai fórumot az MI implementáció kihívásainak és az akadémiai, illetve piaci szereplők közötti együttműködési lehetőségek megvitatására.',
    ...
    'topics' => [
        [
            'title' => 'Generatív AI és fejlett autonóm rendszerek (AGI-irányok)',
            'fileName' => 'ai.png',
        ],
        [
            'title' => 'Ember-gép együttműködés és agentic rendszerek',
            'fileName' => 'drone.png',
        ],
        [
            'title' => 'AI ipari alkalmazásai (gyártás, logisztika)',
            'fileName' => 'ftfl.png',
        ],
        [
            'title' => 'Vállalati tudásmenedzsment és szervezeti integráció',
            'fileName' => 'drone.png',
        ],
        [
            'title' => 'AI és információbiztonság (deepfake, dezinformáció)',
            'fileName' => 'secure_1.png',
        ],
        [
            'title' => 'AI pszichológiai és oktatási vonatkozásai',
            'fileName' => 'ai.png',
        ],
    ],
    'conference_cards' => [
    ...
    'registration' => [
        'speaker_talk_title' => 'Előadás címe',
        'speaker_talk_summary' => 'Rövid leírás',
        'speaker_abstract_upload' => 'Absztrakt feltöltése',
        'title' => 'Regisztráció',
        'attendee' => 'Résztvevő regisztráció',
        'speaker' => 'Előadó regisztráció',
        'name' => 'Név',
        'email' => 'E-mail cím',
        'company' => 'Cég / Egyetem',
        'phone' => 'Telefonszám',
        ...
        'agree' => 'Megismertem az <a href="/public/documents/adatkezeles_hu.pdf" target="_blank">adatkezelési tájékoztatót</a>',
        'submit' => 'Küldés',
    ...
    'speakers' => [
        ...
        'cards' => [
            [
                ...
                'role' => 'Drón Technológia Vezér',
                'bio' => '20 éves tapasztalat az autonóm rendszerek fejlesztésében.',
                'link' => 'Profil megtekintése',
            ],
            [
                'name' => 'Sarah Mueller',
                'role' => 'Drón Startup Alapító',
                'bio' => '3 sikeres drón-based startup alapítása Európában.',
                'link' => 'Profil megtekintése',
            ],
            [
                'name' => 'Prof. László Péter',
                'role' => 'Drón Kutatási Szakértő',
                'bio' => 'Vezetője az EU drón szabályozási bizottságának.',
                'link' => 'Profil megtekintése',
            ],
        ],
    ],
    ...
    'landing' => [
        'alert' => [
          ...
          <br> <br>
                Az <b class="fw-bold">előadói és kiállítói</b> jelentkezéseket a szervezők módosított határidővel <b class="fw-bold">2026. április 30-ig</b> várják. A <b class="fw-bold">részvételi regisztráció</b> személyes jelenlét esetén a rendelkezésre álló férőhelyek függvényében biztosított, online formában pedig folyamatosan elérhető.
            <br><br/>
        ...
        'faq' => [
            ...
            'items' => [
                [
                    'question' => 'Mekkora a konferencia regisztrációs díja?',
                    'answer' => 'A korai regisztrációs díj (március végéig) 29,900 HUF (3 nap), normál díj 39,900 HUF. Vannak kedvezmények csoportos regisztrációra és diákok számára.',
                ],
                [
                    'question' => 'Van-e szállás biztosított?',
                    'answer' => 'Nincs direkt szállás biztosítás, de partneri szállodák az alábbi linkeken kedvezményes tarifákat kínálnak.',
                ],
                [
                    'question' => 'Milyen szintű technikai ismereteket feltételez a konferencia?',
                    'answer' => 'A konferencia minden szinten hozzáférhető. Van kezdő és haladó szintű szekció is.',
                ],
                [
                    'question' => 'Lehet-e online bejelentkezni?',
                    'answer' => 'Nem, a konferencia csak helyszíni részvétellel lehetséges. Azonban egyes keynote előadások később streamelve lesznek.',
                ],
            ],
        ],
    ],
    'footer' => [
        ...
        'links' => [
            ...
            'privacy' => [
                ...
                'url' => '/public/documents/adatkezeles_hu.pdf',
            ],
            'terms' => [
