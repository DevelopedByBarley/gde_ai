                                        ...
                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                          ...
                                          <div class="space-y-3">
                                            ...
                                            <?php if ($registration_type === 'speaker'): ?>
                                              ...
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
                                                Kérjük, következő lépésben töltse fel az előadásához kapcsolódó absztraktot magyar és angol nyelven, az alábbi linken keresztül: <a href="<?= htmlspecialchars($speakerAbstractUrl) ?>" style="color: #0d6efd; text-decoration: underline;"><?= htmlspecialchars($speakerAbstractUrl) ?></a>
                                              </p>
                                              <table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                <tbody>
                                                  <tr>
                                              ...
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
                                                Benyújtási határidő: <strong>2026. április 30.</strong>
                                              </p>
                                              <table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                <tbody>
                                                  <tr>
